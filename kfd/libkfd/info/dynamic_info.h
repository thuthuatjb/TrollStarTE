...
const struct dynamic_info kern_versions[] = {
    ...
    },
    {
        ...
        .proc__p_list__le_next = 0x0000,
        .proc__p_list__le_prev = 0x0008,
        .proc__p_pid = 0x0060,  //14P 16.1.2 FFFFFFF0081AB828, 14PM 16.5 FFFFFFF0081ADEE4
        .proc__p_fd__fd_ofiles = 0xf8,    //14P 16.1.2 FFFFFFF008244C54, 14PM 16.5 FFFFFFF008245110
        .proc__object_size = 0x530,    //guess.. 14P 16.1.2 FFFFFFF0081A4E54(0x528), 14PM 16.5 FFFFFFF0081A7824 (0x728); 0x528 + 0x200 = 0x728, -> 0x730 - 0x200 = 0x530
        .pseminfo__psem_usecount = 0x0004,
        .pseminfo__psem_uid = 0x000c,
        .pseminfo__psem_gid = 0x0010,
        .pseminfo__psem_name = 0x0014,
        ...
        .specinfo__si_rdev = 0x0018,
        .task__map = 0x0028,
        .task__threads__next = 0x0058,    //14P 16.1.2 FFFFFFF007DC6590, 14PM 16.5 FFFFFFF007F13290
        .task__threads__prev = 0x0060,  //calculate task__threads__next + 8
        .task__itk_space = 0x0300,  //14P 16.1.2 FFFFFFF007DE5610, 14PM 16.5 FFFFFFF007E245EC
        .task__object_size = 0x0648,    //14P 16.1.2 FFFFFFF007DAE82C, 14PM 16.5 FFFFFFF007DF0578
        .thread__task_threads__next = 0x0368,   //14P 16.1.2 FFFFFFF007DE5224, 14PM 16.5 FFFFFFF007E2427C
        .thread__task_threads__prev = 0x0370,   //calculate thread__task_threads__next + 8
        .thread__map = 0x0380,  //14P 16.1.2 FFFFFFF007DC2024, 14PM 16.5 FFFFFFF007E02B20
        .thread__thread_id = 0x0420,    //14P 16.1.2 FFFFFFF007DB3200, 14PM 16.5 FFFFFFF007DF4EDC; _thread_tid
        .thread__object_size = 0x04c8,  //14P 16.1.2 FFFFFFF007DC3B94, 14PM 16.5 FFFFFFF007E04528; _thread_reference
        .uthread__object_size = 0x0200, //14P 16.1.2 FFFFFFF007DC6E28, 14PM 16.5 FFFFFFF007E074A8
        .vm_map_entry__links__prev = 0x0000,
        .vm_map_entry__links__next = 0x0008,
        .vm_map_entry__links__start = 0x0010,
        .vm_map_entry__links__end = 0x0018,
        ...
        ._vm_map__hdr__links__end = 0x0028,
        ._vm_map__hdr__nentries = 0x0030,
        ._vm_map__hdr__rb_head_store__rbh_root = 0x0038,    //14P 16.1.2 FFFFFFF007E6F97C, 14PM 16.5 FFFFFFF007EA1978
        ._vm_map__pmap = 0x0040,    //find _get_task_pmap
        ._vm_map__hint = 0x0098,    //14P 16.1.2 FFFFFFF007E2E468, 14PM 16.5 FFFFFFF007E646A0
        ._vm_map__hole_hint = 0x00a0,   //14P 16.1.2 FFFFFFF007E2C478, 14PM 16.5 FFFFFFF007E62750
        ._vm_map__holes_list = 0x00a8,  //14P 16.1.2 FFFFFFF007E2480C, 14PM 16.5 FFFFFFF007E5CD8C
        ._vm_map__object_size = 0x00c0, //14P 16.1.2 FFFFFFF007E2E540, 14PM 16.5 FFFFFFF007E5CDD0
        .kernelcache__kernel_base = 0xfffffff007004000,
        .kernelcache__cdevsw = 0xFFFFFFF00A311168,  //v
        .kernelcache__gPhysBase = 0xFFFFFFF00784BD50,   //v
        .kernelcache__gPhysSize = 0xFFFFFFF00784BD58,   //v
        .kernelcache__gVirtBase = 0xFFFFFFF007849F38,   //v
        .kernelcache__perfmon_devices = 0xFFFFFFF00A34C310, //v
        .kernelcache__perfmon_dev_open = 0xFFFFFFF007EC0288,    //v
        .kernelcache__ptov_table = 0xFFFFFFF0077FFA18,  //v
        .kernelcache__vm_first_phys_ppnum = 0xFFFFFFF00A34B780, //v
        .kernelcache__vm_pages = 0xFFFFFFF0077FC6D8,    //v
        .kernelcache__vm_page_array_beginning_addr = 0xFFFFFFF0077FE9D8,    //v
        .kernelcache__vm_page_array_ending_addr = 0xFFFFFFF00A34B778,   //v
        .kernelcache__vn_kqfilter = 0xFFFFFFF007F101A0, //v
    },
};
